...
// Datum axis feature: line segment defined by origin, direction and length
// - Origin: axis start point in world coords (Ox/Oy/Oz)
// - Direction: normalized direction vector (Nx/Ny/Nz)
// - Length: segment length from origin along direction
// - FixedGeometry: marks it as non-editable datum helper
...
public:
  ...
  void setLength(double l) { params()[Feature::ParamKey::Length] = l; }
